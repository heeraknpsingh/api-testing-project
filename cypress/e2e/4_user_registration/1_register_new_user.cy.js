describe("API Tests: Register user ", function(){
  beforeEach(function () {
    cy.fixture('users/data.json').then((data) => {
      this.payload = data["register_user"]
    })
  })
  ...
  it("should register new user ", function(){
    ...
    cy.request("POST", "users/register", this.payload).as("user")
  ...
  it("should not register user with same emailid ", function(){
